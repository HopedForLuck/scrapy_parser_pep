...
# По тестам нужна переменная BASE_DIR, не придумал ничего умнее кроме вызова "родителя" у "родителя"
# Дальше в коде где используется BASE_DIR закомментирован вариант без BASE_DIR, не знаю чем он плох
